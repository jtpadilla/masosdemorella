...
- límits municipals, denes, camins i cims: © col·laboradors d'OpenStreetMap, llicència ODbL (https://www.openstreetmap.org/copyright);
- topònims i vies pecuàries: Nomenclàtor Toponímic Valencià i Inventari de vies pecuàries, Generalitat Valenciana / Institut
  Cartogràfic Valencià, llicència CC BY 4.0;
- topònims de contrast: Nomenclátor Geográfico Básico de España, i ortofotografia PNOA, Instituto Geográfico Nacional,
  llicència CC BY 4.0.

El programari del repositori (scripts d'extracció, generadors de mapes i lloc web) té llicència MIT: vegeu `LICENSE`.
