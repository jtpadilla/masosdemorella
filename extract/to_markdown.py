...
INSERTS = {   # clave = inicio del bloque tras el que se inserta
    ...
    "![Mapa dels Ports](": "![Relleu i rius del terme de Morella: les muntanyes, els rius i el port de Torremiró que cita "
                           f"el capítol, i els municipis veïns]({IMG}/ed-relleu-i-rius.svg)",
